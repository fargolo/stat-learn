...
In the set of orbits $R$, consider a potentially non empty set of spirals $S'$ whose involutions define arcs constinously rotated towards non-trivial values of $Re(\zeta(s))=0$.  
